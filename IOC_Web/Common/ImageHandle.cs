...
namespace IOC_Web.Common
{
    ...
    public class ImageHandle
    {
        ...
        public static void FixedAuto(System.IO.Stream fromFile, string savePath, System.Double targetWidth, System.Double targetHeight, string watermarkText, string watermarkImage)
        {
            ...
            try
            {
                ...
                //生成新图
                //新建一个bmp图片
                newImage = new System.Drawing.Bitmap((int)targetWidth, (int)targetHeight);
                //新建一个画板
                ...
                //水印
                WaterMark(ref newImage, watermarkText, watermarkImage);
        ...
        public static void WaterMark(ref System.Drawing.Image newImage, string watermarkText, string watermarkImage)
        {
            //文字水印
            if (watermarkText != "")
            {
                using (System.Drawing.Graphics gWater = System.Drawing.Graphics.FromImage(newImage))
                {
                    System.Drawing.Font fontWater = new Font("宋体", 12);
                    System.Drawing.Brush brushWater = new SolidBrush(ColorTranslator.FromHtml("#CCCCCC"));
                    gWater.DrawString(watermarkText, fontWater, brushWater, 10, newImage.Height - 20);
                    gWater.Dispose();
                }
            }
                ...
                if (File.Exists(watermarkImage))
                {
                    ...
                    using (System.Drawing.Image wrImage = System.Drawing.Image.FromFile(watermarkImage))
                    {
                        ...
                        if (newImage.Width >= wrImage.Width && newImage.Height >= wrImage.Height)
                        {
                            ...
                            ColorMatrix wmColorMatrix = new ColorMatrix(colorMatrixElements);
                            imgAttributes.SetColorMatrix(wmColorMatrix, ColorMatrixFlag.Default, ColorAdjustType.Bitmap);
                            gWater.DrawImage(wrImage, new Rectangle((newImage.Width / 2) - (wrImage.Width / 2), (newImage.Height / 2) - (wrImage.Height / 2), wrImage.Width, wrImage.Height), 0, 0, wrImage.Width, wrImage.Height, GraphicsUnit.Pixel, imgAttributes);
                            gWater.Dispose();
                        }
                        wrImage.Dispose();
                    }
